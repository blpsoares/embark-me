  ...
  return (
    <section className="relative bg-black border-t border-white/[0.06] overflow-hidden">
      ...
      <div className="relative px-6 py-32 max-w-2xl mx-auto text-center">
        <h2 className="text-[clamp(1.75rem,3.2vw,2.75rem)] font-semibold text-zinc-100 mb-10 tracking-tight leading-tight">
          {t.coverageClose.title}
        </h2>
        <a
          href="https://github.com/blpsoares/parity-driven-development"
          className="inline-block bg-accent text-black font-semibold text-base px-7 py-3.5 rounded-lg shadow-[0_0_40px_-6px_#34d399] hover:shadow-[0_0_56px_-6px_#34d399] transition-shadow"
        >
          {t.coverageClose.cta}
        </a>
      </div>
