...
export default function StageSection({ stageId, tag, title, description, why, children }: StageSectionProps) {
  ...
  return (
    <section className="stage relative flex flex-col lg:flex-row lg:items-center gap-10 lg:gap-16 px-6 md:pl-14 lg:pl-20 md:pr-10 py-16 md:py-24 lg:py-28 max-w-[1240px] mx-auto">
      ...
      <div className="stage-copy flex-1 min-w-0">
      ...
      <div className="sim flex-1 min-w-0 w-full lg:max-w-[560px] bg-[#0d2438] border border-accent-soft shadow-2xl relative overflow-visible p-5 sm:p-6 md:p-7">
