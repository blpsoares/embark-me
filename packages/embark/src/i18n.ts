...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "start.step2.title": "Initialize Repository",
    "start.step2.desc": "Run the init script to remove demo files, configure the upstream remote and merge protection, and optionally reset Git history.",
  ...
  pt: {
    ...
    "start.step2.title": "Inicializar Repositório",
    "start.step2.desc": "Execute o script init para remover os arquivos demo, configurar o remote upstream e proteção de merge, e opcionalmente resetar o histórico Git.",
